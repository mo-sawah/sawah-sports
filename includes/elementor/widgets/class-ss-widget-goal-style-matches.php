...
class Sawah_Sports_Widget_Goal_Style_Matches extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control('show_temperature', [
            'label' => __('Show Match Temperature/Info', 'sawah-sports'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'default' => 'no',
            'description' => __('Show weather or match info icons', 'sawah-sports'),
        ]);
    ...
    protected function render() {
        ...
        <div id="ss-goal-matches-<?php echo esc_attr($widget_id); ?>" 
            ...
            <!-- Top Bar: Competition Filter + Date Slider -->
            <div class="ss-goal-top-bar">
                <!-- Competition Dropdown -->
                <div class="ss-goal-competition-wrapper">
                ...
                <!-- Date Navigation -->
                <div class="ss-goal-date-navigation">
